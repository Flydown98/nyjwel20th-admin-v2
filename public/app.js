...
async function refreshDashboard(){
  ...
  $('#statusBadge').textContent='연결됨 · v0.9.37';$('#statusBadge').classList.add('ok');$('#roleBadge').textContent=d.roleLabel||currentRole;
...
if('serviceWorker' in navigator){
  window.addEventListener('load',()=>navigator.serviceWorker.register('/sw.js?v=0.9.37',{updateViaCache:'none'}).then(r=>r.update()).catch(()=>{}));
}
